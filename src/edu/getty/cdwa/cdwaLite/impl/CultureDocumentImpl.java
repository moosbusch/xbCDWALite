 ...
 */
public class CultureDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.getty.cdwa.cdwaLite.CultureDocument
{
    private static final long serialVersionUID = 1L;
    
    public CultureDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public edu.getty.cdwa.cdwaLite.CultureDocument.Culture getCulture()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.getty.cdwa.cdwaLite.CultureDocument.Culture target = null;
            target = (edu.getty.cdwa.cdwaLite.CultureDocument.Culture)get_store().find_element_user(CULTURE$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public static class CultureImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements edu.getty.cdwa.cdwaLite.CultureDocument.Culture
    {
        private static final long serialVersionUID = 1L;
        ...
        protected CultureImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
