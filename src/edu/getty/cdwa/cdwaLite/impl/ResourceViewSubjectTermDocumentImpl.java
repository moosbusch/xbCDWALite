 ...
 */
public class ResourceViewSubjectTermDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument
{
    private static final long serialVersionUID = 1L;
    
    public ResourceViewSubjectTermDocumentImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    
    private static final javax.xml.namespace.QName RESOURCEVIEWSUBJECTTERM$0 = 
     ...
     */
    public edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm getResourceViewSubjectTerm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm target = null;
            target = (edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm)get_store().find_element_user(RESOURCEVIEWSUBJECTTERM$0, 0);
            if (target == null)
            {
                return null;
            }
    ...
    public edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm addNewResourceViewSubjectTerm()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm target = null;
            target = (edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm)get_store().add_element_user(RESOURCEVIEWSUBJECTTERM$0);
            return target;
        }
    }
    /**
     ...
     */
    public static class ResourceViewSubjectTermImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements edu.getty.cdwa.cdwaLite.ResourceViewSubjectTermDocument.ResourceViewSubjectTerm
    {
        private static final long serialVersionUID = 1L;
        
        public ResourceViewSubjectTermImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected ResourceViewSubjectTermImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
