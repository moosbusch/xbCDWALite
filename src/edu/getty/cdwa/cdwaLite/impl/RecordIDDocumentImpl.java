 ...
 */
public class RecordIDDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements edu.getty.cdwa.cdwaLite.RecordIDDocument
{
     ...
     */
    public edu.getty.cdwa.cdwaLite.RecordIDDocument.RecordID getRecordID()
    {
        synchronized (monitor())
        {
            check_orphaned();
            edu.getty.cdwa.cdwaLite.RecordIDDocument.RecordID target = null;
            target = (edu.getty.cdwa.cdwaLite.RecordIDDocument.RecordID)get_store().find_element_user(RECORDID$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public static class RecordIDImpl extends org.apache.xmlbeans.impl.values.JavaStringHolderEx implements edu.getty.cdwa.cdwaLite.RecordIDDocument.RecordID
    {
        private static final long serialVersionUID = 1L;
        
        public RecordIDImpl(org.apache.xmlbeans.SchemaType sType)
        {
            super(sType, true);
        }
        
        protected RecordIDImpl(org.apache.xmlbeans.SchemaType sType, boolean b)
        {
            super(sType, b);
        }
